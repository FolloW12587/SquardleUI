                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 10){
                        ...
                        Group {
                            ...
                            Text("Вводи слова из пяти букв и жми \"Ввод\". Введенное слово появится как в столбце, так и в колонке, и по каждой букве Вы получите подсказки, о которых мы поговорим позднее.\n\nВ начале Вам дается 9 попыток. За каждое из первых пяти слов, для которого Вы откроете все буквы, Вы получите по дополнительной попытке. Шестое отгаданное слово принесет Вам победу! Заметьте, что необязательно вводить конкретное слово, чтобы оно считалось отгаданным, главное, открыть все буквы.")
                        }
