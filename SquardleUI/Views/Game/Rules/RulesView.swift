                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 10){
                        ...
                        Group {
                            ...
                            HintRuleView(state: .existsInRowOrColumn(inRowCount: 1, inColumnCount: 0), width: geometry.size.width / 5, text: " - буквы \"А\" нет ни в этой клетке ни в колонке, но есть как МИНИМУМ одна где-то в этой строке. Она также может указывать на открытую букву.")
                            
                            HintRuleView(state: .existsInRowOrColumn(inRowCount: 0, inColumnCount: 1), width: geometry.size.width / 5, text: " - буквы \"А\" нет ни в этой клетке ни в строке, но есть как МИНИМУМ одна где-то в этой колонке. Она также может указывать на открытую букву.")
