    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Group {
                ...
                Text("В течении игры Вы будете получать все больше и больше подсказок, но мы ограничены размерами экрана, чтобы уместить их всех в удобном формате. В случае, если у Вас есть затруднения в чтении подсказки, нажмите на нее , она раскроется на всю клетку. Чтобы вернуть все как было, нажмите на нее снова.\n\nТакже подсказок может становиться много, они могут начать дублировать друг-друга или дополнять. Чтобы не отвлекаться на такие подсказки, Вы можете скрыть их, нажав на них и подержав палец пару секунд. Чтобы снова их посмотреть, нажмите на сокрытую подсказку снова.\n\nПопробовать как это работает Вы можете на интерактивной подсказке ниже.")
